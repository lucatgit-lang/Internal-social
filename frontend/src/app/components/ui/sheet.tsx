...
/**
 * Sheet: descrive il comportamento principale di questa funzione.
...
/**
 * SheetHeader: descrive il comportamento principale di questa funzione.
...
/**
 * SheetFooter: descrive il comportamento principale di questa funzione.
 * @param className Input richiesto dalla funzione.
 * @param props Input richiesto dalla funzione.
 * @returns Valore restituito dalla funzione secondo il contratto corrente.
 * @sideeffects Pu? produrre effetti collaterali previsti dal flusso esistente (I/O, stato, log o rete).
